            ...
            <li class="nav_down">
                ...
                <ul id="nav_down" class="t_center">
                    <c:forEach items="${subjectList}" var="subject">
                        <li>
                            <a target="_self"
                               href="${pageContext.request.contextPath}/course/findById/${subject.id}">${subject.subjectName}</a>
                        </li>
                    </c:forEach>
                </ul>
            </li>
    ...
    <div class="container">
        ...
        <div class="course-info">
            <table cellspacing="10">
                <tr>
                    <td colspan="2">
                        <a href="${pageContext.request.contextPath}/course/findById/1">
                    ...
                    <td>
                        <!--上线时修改id-->
                        <a href="${pageContext.request.contextPath}/course/findById/6">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <a href="${pageContext.request.contextPath}/course/findById/10">
                ...
                <tr>
                    <td colspan="2">
                        <a href="${pageContext.request.contextPath}/course/findById/11">
